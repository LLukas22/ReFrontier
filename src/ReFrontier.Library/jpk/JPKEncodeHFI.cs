...
namespace ReFrontier.Library.jpk
{
    ...
    {
        private static short m_hfTableLen = 0x1fe;
        private short[] m_hfTable = new short[m_hfTableLen];
        private short[] m_Paths = new short[0x100];
        private short[] m_Lengths = new short[0x100];
